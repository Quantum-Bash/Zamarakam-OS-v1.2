...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    self.root = root
    # Title of the window
    self.root.title("Zamarakam-EDIT")
    # Window Geometry
    ...
    # Initializing Status
    self.status.set("Welcome To Zamarakam-EDIT")
    # Creating Menubar
  ...
  def infoabout(self):
    messagebox.showinfo("About Text Editor","Zamarakam-EDIT is a simple text editor included with the Zamarakam OS")
